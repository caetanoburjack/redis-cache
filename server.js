...
//URL copied from API
const requestUrl = `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/Lisbon?unitGroup=metric&include=current&key=PXE5V4MHYEUF4PBK4BL9J7NMN&contentType=json`;
